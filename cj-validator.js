...
class CjValidator {
    ...
    async validate(ctx, alias) {
        ...
        const tmpData = lodash_1.cloneDeep(this.data);
        this.parsed = Object.assign(Object.assign({}, tmpData), { default: {} });
        if (!(await this.checkRules())) {
            ...
            throw new exception_1.ParametersException({ msg: obj, ...this.ex});
        }
        else {
            ctx.v = this;
            return this;
    ...
    get(path, parsed = true) {
        ...
        if (parsed) {
            const key = lodash_1.get(this.parsed, path, defaultVal && defaultVal);
            if (!this.isOptional(key)) {
                ...
                return lodash_1.get(this.parsed['default'], suffix, defaultVal && defaultVal);
            }
        }
        else {
    ...
    findInData(key) {
        ...
        for (const k of keys) {
            const val = lodash_1.get(this.data[k], key);
            if (val !== void 0) {
                return [k, val];
            }
        }
            ...
            switch (this.validateFunction) {
                case 'isInt':
                    if (typeof value === 'string') {
                        this.parsedValue = validator_1.default.toInt(value);
                        return validator_1.default.isInt(value, ...this.options);
                    }
                    else {
                        this.parsedValue = value;
                        return validator_1.default.isInt(String(value), ...this.options);
                    }
                case 'isFloat':
                    if (typeof value === 'string') {
                        this.parsedValue = validator_1.default.toFloat(value);
                        return validator_1.default.isFloat(value, ...this.options);
                    }
                    else {
                        this.parsedValue = value;
                        return validator_1.default.isFloat(String(value), ...this.options);
                    }
                case 'isBoolean':
                    if (typeof value === 'string') {
                        this.parsedValue = validator_1.default.toBoolean(value);
                        return validator_1.default.isBoolean(value);
                    }
                    else {
                        this.parsedValue = value;
                        return validator_1.default.isBoolean(String(value));
                    }
                case 'isNotEmpty':
                    return extended_validator_1.extendedValidator.isNotEmpty(value);
                default:
                    return validator_1.default[this.validateFunction](value, ...this.options);
            }
        }
    }
}
